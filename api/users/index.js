...
router.put("/:id/toggleActive", isLoggedIn, isAdmin, controller.toggleActive);
router.post("/adminSendEmail", isLoggedIn, isAdmin, controller.sendCustomEmail);

router.put(
  "/:id/notification_read/:notification",
  isLoggedIn,
  controller.markNotificationRead
);
router.delete(
  "/:id/notification_delete/:notification",
  isLoggedIn,
...
router.post(
  "/:id/togl_notifications/likes",
  isLoggedIn,
  controller.tgl_notification_for_likes
);
router.post(
  "/:id/togl_notifications/sentences",
  isLoggedIn,
  controller.tgl_notification_for_sentences
);
router.post(
  "/:id/togl_notifications/achievements",
  isLoggedIn,
  controller.tgl_notification_for_achievements
);
